...
video = cv2.VideoCapture('video1/video_4.mp4')
frames = []
...
video_writer = cv2.VideoWriter('static/output-videos/video_4.mp4', cv2.VideoWriter_fourcc(*'MP4V'), 24, keyshots.shape[2:0:-1])
